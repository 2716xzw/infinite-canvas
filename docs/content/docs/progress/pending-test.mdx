...
- MiniMax H3 video resolution: selecting the model should show only 1440p and 768p, default to 1440p, and submit the matching `resolution` value accepted by the API.
